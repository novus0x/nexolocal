...
from routes.companies import company, products, finance, sales, c_dashboard, cash, suppliers
...
app.include_router(suppliers.router, prefix="/api/company/suppliers", tags=["Suppliers", "Company"])
